  ...
  ar: [
    {
      number: "01",
      title: "أرسل فكرتك",
      description: "كلمنا واتساب، نفهم فكرتك ونحدد المطلوب بالضبط خلال جلسة واحدة",
    },
    {
      number: "02",
...
export const TRANSLATIONS: Translations = {
  ...
  ar: {
    ...
    ui: {
      ...
      ctaMain: "مستعد تبدأ؟",
      ctaSubtitle: "أرسل لنا فكرتك على واتساب وخلال 14 يوم تطبيقك يكون جاهز",
      ...
      problemSubtitle: "عندك فكرة تطبيق بس كل ما تسأل مطوّر يقولك شهور وأرقام خيالية",
      ...
      ctaFinalTitle: "فكرتك تستاهل تطبيق",
      ctaFinalButton: "أرسل فكرتك الآن",
